...
export const discoveryVolumeSchema = z.object({
  comicvine_id: z.number().int(), metadata_source: z.enum(['comicvine', 'mangadex']).optional(), metadata_id: z.string().optional(), metadata_language: z.string().optional(), available_languages: z.array(z.string()).optional(), title: z.string(), year: z.number().int().nullable().optional(), publisher: z.string().nullable().optional(), volume_number: z.number().optional(), cover_link: z.string().nullable().optional(), cover_url: z.string().nullable().optional(), id: z.number().int().optional(), already_added: z.number().int().nullable().optional(), issue_count: z.number().int().nullable().optional(), issue_number: z.string().optional(), cover_date: z.string().optional(), date_added: z.string().nullable().optional(), volume_title: z.string().optional(), status: z.string().nullable().optional(), metadata_source_label: z.string().optional(), source_note: z.string().nullable().optional(), original_language: z.string().nullable().optional(), demographic: z.string().nullable().optional(), content_rating: z.string().nullable().optional(),
}).passthrough();
export type DiscoveryVolume = z.infer<typeof discoveryVolumeSchema>;

export const discoveryPageSchema = z.object({ items: z.array(z.record(z.unknown())), total: z.number().int().nonnegative().nullable(), offset: z.number().int().nonnegative(), page_size: z.number().int().positive(), has_more: z.boolean().optional(), next_offset: z.number().int().nonnegative().nullable().optional(), next_cursor: z.string().nullable().optional(), previous_cursor: z.string().nullable().optional(), cursor_history: z.array(z.string()).optional(), total_is_exact: z.boolean().optional(), source_note: z.string().nullable().optional(), is_bounded: z.boolean().optional(), maximum_per_year: z.number().int().positive().optional(), years_included: z.array(z.number().int()).optional(), coverage_state: z.string().optional(), coverage_complete: z.boolean().optional(), last_completed_at: z.number().nullable().optional(), last_error: z.string().nullable().optional(), sync_task_id: z.number().nullable().optional() });
