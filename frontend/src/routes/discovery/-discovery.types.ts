...
export interface BrowseFilters { section: DiscoverySection; q?: string; publisher?: string; decade?: string; status?: string; tags?: string; demographic?: string; original_language?: string; year?: string; author?: string; artist?: string; content_rating?: string; sort: BrowseSort; }
