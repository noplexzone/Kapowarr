...
export function ComicsPage({ section = 'comic', canonical = false }: ComicsPageProps) {
  ...
  }, [pendingAction, queryClient, search.direction, search.filter, search.search, search.sort, search.view, section]);
  ...
  return (
    <div className={styles.page}>
      <div className={styles.libraryHeader}>
        ...
        {false && <div className={styles.savedViewsRow} aria-label={`${section === 'comic' ? 'Comics' : 'Manga'} saved views`}>
        ...
        {false && visibleMissingVolumes.length > 0 && (
